...
insert into utilisateur (est_victime, code_secret, mdp, nom, num_dossier, prenom) values (true,'CGRP16','$2y$10$7oyvjE1esYgl.062Mph8cepT9/hFq5EY2tf5hxBt3b/KZIP2xCITG','fraioli','57721','stephane'),(true,'mystere2','$2y$10$7oyvjE1esYgl.062Mph8cepT9/hFq5EY2tf5hxBt3b/KZIP2xCITG','anelka','22754','francine'),(true,'mystere3','$2y$10$7oyvjE1esYgl.062Mph8cepT9/hFq5EY2tf5hxBt3b/KZIP2xCITG','varni','57721','frédéric'),(true,'mystere3','$2y$10$7oyvjE1esYgl.062Mph8cepT9/hFq5EY2tf5hxBt3b/KZIP2xCITG','bousquet','43013','danielle');
insert into utilisateur_roles (roles_id, utilisateur_id) VALUES (1,1), (2,1),(2,2),(2,3),(2,4),(2,5),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13);
